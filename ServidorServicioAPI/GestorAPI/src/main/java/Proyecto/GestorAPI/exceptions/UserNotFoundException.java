...
/**
 * Excepción personalizada para manejar casos en los que no se encuentra un usuario en la base de datos.
...
public class UserNotFoundException extends RuntimeException {
     ...
     *
     * @param message El mensaje que describe el motivo de la excepción (por ejemplo, "Usuario no encontrado").
     */
