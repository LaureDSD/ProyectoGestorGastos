...
/**
 * Extractor personalizado para obtener la información del usuario de GitHub a través de OAuth2.
 * Implementa la interfaz {@link OAuth2UserInfoExtractor} para extraer y mapear la información
 * del usuario de GitHub al formato de {@link CustomUserDetails}.
 */
@Service
public class GitHubOAuth2UserInfoExtractor implements OAuth2UserInfoExtractor {

    /**
     * Extrae la información del usuario de GitHub y la mapea a un objeto {@link CustomUserDetails}.
     *
     * @param oAuth2User el usuario autenticado proveniente de GitHub.
    ...
    public CustomUserDetails extractUserInfo(OAuth2User oAuth2User) {
        ...
        // Extrae el nombre de usuario de GitHub
        ...
        // Extrae la URL del avatar del usuario
        customUserDetails.setAvatarUrl(retrieveAttr("avatar_url", oAuth2User));

        // Establece el proveedor como GitHub
        customUserDetails.setProvider(OAuth2Provider.GITHUB);

        // Establece los atributos del usuario (todo lo que devuelve GitHub)
    ...
    /**
     * Determina si este extractor acepta la solicitud de un proveedor OAuth2 determinado (en este caso, GitHub).
     *
     * @param userRequest la solicitud de OAuth2 que contiene la información del proveedor.
     * @return true si el proveedor es GitHub, false en caso contrario.
     */
    @Override
